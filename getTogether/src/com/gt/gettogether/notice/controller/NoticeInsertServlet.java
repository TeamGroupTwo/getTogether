...
public class NoticeInsertServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// -- 파일 처리용 Multipart Files 로직 작성부 -- //
				...
				String savePath = root+"resources/noticeFiles";
				String fileType = "FL";
				...
				int result1 = new NoticeService().fileUpload(nf);
				
				
				if(result1 > 0 ){
					
					NoticeNFiles nf1 = new NoticeNFiles();
					
					nf1.setnTitle(title);
					nf1.setnContent(content);
					nf1.setnWriter(writer);
					nf1.setnFix(noticeYN);
					nf1.seteNo(eNo);
					
					
				int result2 = new NoticeService().insertNotice(nf1);
